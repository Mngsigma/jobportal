...
City: <br><input type="text" name="t5"style="width: 45%; " name="id" class="form-control"> <br>
10th: <br><input type="text" name="t6" style="width: 45%; " name="id" class="form-control"> <br>
12th: <br><input type="text" name="t7" style="width: 45%; " name="id" class="form-control"> <br>
graduation: <br><input type="text" name="t8" style="width: 45%; " name="id" class="form-control"> <br>

Password: <br><input type="text" name="t9" style="width: 45%; " name="id" class="form-control"> <br>

Photo: <br> <input type="file" src=""  name="file" alt=""> <br> <br>
Skill: <br><input type="text" name="t10" style="width: 45%; " name="id" class="form-control"> <br>
...
<?php
    ...
    if(isset($_POST['t1'])==true)
    {
      ...
      $j="insert into candidatereg values('$a','$b','$c','$d','$e','$f','$g','$h','$i','$n','$j')";
      $rs=mysqli_query($con,$j);
      if($rs)
      {
         echo"<br><h1><script type='text/javascript'>alert('Successfully Register Dear $a');</script>Registeration  successfully...!!</h1>";
      }
      else
      {
