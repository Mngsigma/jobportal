...
<div class="col-md-8">
<a href="cmplogin.php" style="width:20%;  height:40%;" class="btn btn-primary">Company</a> <br> <br>
<a href="candidatelogin.php" style="width:20%; height:40%;" class="btn btn-primary">Candidate</a>
</div>
<div class="col-md-2">
