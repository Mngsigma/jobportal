...
<div class="col-md-8"> <form method='POST' action=""><h3>Candidate Log-In</h3>
...
<?php
     ...
     if(isset($_POST['email'])==true)
     {
        ...
        $con=mysqli_connect('localhost','root','123456789','jobportal','3306');
         $j="select * from candidatereg where email='$a' and password='$b' ";
         $rs=mysqli_query($con,$j);
         if($row=mysqli_fetch_array($rs))
         {session_start();
          $_SESSION['x']=$_POST['email'];
           echo"<script>window.location='candidatehome.php'</script>";
         }
         else
         {
